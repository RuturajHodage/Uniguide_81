...
insert into user_login values(default,"gauravaher@gmail.com","1234","admin","Gaurav");
...
insert into app_feedback values(1,now(),"good application for student ",5,5);
insert into app_feedback values(2,DATE_ADD(now(), INTERVAL 7 DAY),"very useful for students eho are serching for good college ",4,4);
insert into app_feedback values(3,DATE_ADD(now(), INTERVAL 10 DAY)," really helpful",5,3);
insert into app_feedback values(4,DATE_ADD(now(), INTERVAL 3 DAY),"application is seemless",5,2);
insert into app_feedback values(5,DATE_ADD(now(), INTERVAL 5 DAY),"application is easy to use",3,1);
...
insert into recruiters values(default,DATE_ADD(now(), INTERVAL 7 DAY),DATE_ADD(now(), INTERVAL 7 DAY),"skills in mongodb,any programming language ,communication skill","Analyst","https://www.freshersnow.com/cognizant-recruitment/","cognizant",now());
...
insert into college_predictor values (1,"JEE",60,62.2,68.2,60.3,64.6,2,1,4);
insert into college_predictor values (2,"JEE",80,84.2,78.2,81.3,84.6,1,7,4);
insert into college_predictor values (3,"NEET",680,684,640,604,600,11,4,8);
insert into college_predictor values (4,"12th percentage",65,64.2,62.2,61.3,68.6,5,8,7);
insert into college_predictor values (5,"CET",80,84.2,78.2,81.3,84.6,3,3,4);



insert into college_ranking values(1,2,1,4);
insert into college_ranking values(2,5,5,6);
insert into college_ranking values(3,8,9,8);
insert into college_ranking values(4,87,7,4);
insert into college_ranking values(5,24,4,8);
insert into college_ranking values(6,45,6,4);
insert into college_ranking values(7,76,2,4);
insert into college_ranking values(8,121,3,4);
insert into college_ranking values(9,99,8,7);

insert into event values(1,"Career guidance seminar","Shivaji nagar","Career guidance","SPPU",now()+interval 7 day);
insert into event values(2,"World Education fair","Chinchwad","The World Education Fair organized by Edwise","Edwise International",now()+interval 3 day);
insert into event values(3,"Global Art & Design Education Expo 2023","Blue Diamond,Pune","India’s biggest Art and Design ",now()+interval 2 day);
insert into event values(4,"SAE Meetup","Model Colony","Discussion meet","SAE-India",now()+interval 1 day);
insert into event values(5,"Placement Guidance","COEP","Placement guidance","COEP",now()+interval 6 day);
insert into event values(6,"Auto-Expo","Pashan","Exibition","SK events",now()+interval 8 day);
insert into event values(7,"Communication skill workshop","Ravet","Communicational skill","RSCOE",now()+interval 10 day);
insert into event values(8,"Money management","swargate","Perosnal growth","SS foundation",now()+interval 20 day);
insert into event values(9,"Science Exhibition","Chinchwad","Science and technology","Science community",now()+interval 17 day);
insert into event values(10,"Career guidance seminar","Shivaji nagar","Career guidance","SPPU",now()+interval 7 day);


#intake_vacancy
insert into intake_vacancy values(1,"10 th result, 12 th result",120000,240,120,1,3,4);
insert into intake_vacancy values(2,"10 th result, 12 th result,aadhar card",72000,140,12,2,1,4);
insert into intake_vacancy values(3,"10 th result, 12 th result,pan card",120000,280,100,3,2,4);
insert into intake_vacancy values(4,"10 th result, 12 th result,caste certificate",180000,140,10,11,9,8);
insert into intake_vacancy values(5,"10 th result, Leaving certificate",125000,250,134,5,8,6);
insert into intake_vacancy values(6,"10 th result,birth certificate",120344,243,20,1,6,4);
insert into intake_vacancy values(7,"10 th result, all marksheets",156770,340,130,2,7,4);
insert into intake_vacancy values(8,"10 th result, Entrance exam marks",124400,330,43,3,4,4);
insert into intake_vacancy values(9,"10 th result, JEE marksheet",43234,250,150,1,1,4);
insert into intake_vacancy values(10,"10 th result, CET marksheet",12005,20,10,6,8,7);


#college feedback
insert into feedback values(1,now(),"Great academic institute",null,null);
insert into feedback values(2,now()-interval 3 day,"Great academic institute",null,null);
insert into feedback values(3,now()-interval 2 day,"Trained faculties",null,null);
insert into feedback values(4,now()-interval 5 day,"Good infrastructure",null,null);
insert into feedback values(5,now()-interval 2 day,"Qulified teaching staff",null,null);
insert into feedback values(6,now()-interval 6 day,"Flexible environmenr",null,null);
insert into feedback values(7,now()-interval 10 day,"High placement opportunities",null,null);
insert into feedback values(8,now()-interval 15 day,"Highly Recommended institute",null,null);
insert into feedback values(9,now()-interval 10 day,"Updated instruments avialable",null,null);
insert into feedback values(10,now()-interval 7 day,"bad environment",null,nulls);
