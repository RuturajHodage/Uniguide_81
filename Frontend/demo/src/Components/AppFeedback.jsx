    ...
    <div className="app-box app-feedback-form " style={{alignSelf:'center',margin:'auto',marginTop:'10px',marginBottom:"10px"}}>
                <h2 className="app-heading1">Application Feedback</h2><br></br><br></br>
                    ...
                    <input
                        ...
                        className={formData.appfeedDate.length ? '': 'error'}
                        required 
                    />
                    </label>
                    <br />
                    ...
                    <textarea
                        ...
                        onChange={handleInputChange}
                        className={formData.appfeedDesc.length ? '': 'error'}
                        required 
                    />
                    </label>
                    <br />
                   ...
                   Rating:
                    ...
                    <input
                        ...
                        onChange={handleInputChange}
                        className={formData.userId.length ? '': 'error'}
                        required 
                    />
                    </label>
                    <br />
