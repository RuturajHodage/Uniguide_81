    ...
    <div className="" >
            ...
            
        {
         ...
         Universities.map((curElem) => {
                     ...
                     const { uniImage, uniName, uniDescription,uniId,uniAddress, uniCity,uniWebsite,uniRank ,uniState} = curElem;
                return (
                      <div className="col-10 col-md-4 mt-5 custom-card" key={uniId} style={{marginBottom:"50px"}} >
              <div className="card p-2">
                        <div className="d-flex align-items-center" style={{padding:"20px"}}>
                                <div className="image" align="center" style={{margin:"auto",paddigTop:"10px"}}> <img src={ hardcodedImageURL } className="rounded" width="155" /> </div>
                            <div className="ml-3 w-100 " style={{alignContent:""}}>
                                    <h3 className="mb-0 mt-0 textLeft"><b>Name : </b>{uniName}</h3>
                                    <br></br>
                          <ul className='custom-ul'>
                            <li><span className="text-left"> <b>University Description : </b> {uniDescription}</span></li>
                                   <li><b>NIRF Rank : </b>{ uniRank}</li>
                                    <li><span className="text-left"><b> Address : </b>{uniAddress }</span></li>
                            <li><b>City : </b>{uniCity}, {uniState}</li>
                            <li><b>Website : </b><a href={uniWebsite}>Click here</a></li>
                                    </ul>                              
                            </div>
                     </div>
                  </div>
