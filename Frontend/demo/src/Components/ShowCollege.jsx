...
const ShowCollege = () => {
  ...
  useEffect(() => {
   try{
    axios.get(`${URL}/college/search/${colleges}`)
      .then((response) => {
      ...
      .catch((error) => {
        ...
        toast.warning('no colleges found')
      }
  ...
  return (
    <div className="college-list ">
      <h1>College List</h1>
      {col.map((college, index) => (
        <div key={index} className="college-card box-hover">
          <img src={hardcodedImageURL} alt={college.name} className="college-image" />
              <center><h2>{college.clgName}</h2></center> <br></br>
              {/* <p><b>University:</b> {college.uniId.uniName}</p><br></br> */}
              <p><b>Description:</b> {college.clgDescription}</p><br></br>
              <p><b>Address:</b> {college.clgAddress}</p><br></br>
              <p><b>City:</b> {college.clgCity}</p><br></br>
              <p><b>Website:</b> <a href={college.clgWebsite}>Click here</a></p><br></br>
